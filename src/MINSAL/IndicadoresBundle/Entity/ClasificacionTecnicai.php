...
class ClasificacionTecnicai
{
    ...
    * @ORM\OneToMany(targetEntity="IndicadorAlertasseg", mappedBy="indicador", cascade={"all"}, orphanRemoval=true)
    *
    */
    private $alertas;
    /**
    ...
    private $descripcion;
/**
     * @var string $descripcionm
     *
     * @ORM\Column(name="descripcionm", type="string", length=150, nullable=true)
     */
  ...
  /**
     ...
     * Add alertas
     *
     * @param  MINSAL\IndicadoresBundle\Entity\IndicadorAlertasseg $alertas
     * @return ClasificacionTecnicai
     */
