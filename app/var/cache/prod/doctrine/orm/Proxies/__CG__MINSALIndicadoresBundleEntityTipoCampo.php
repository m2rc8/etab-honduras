 ...
 */
class TipoCampo extends \MINSAL\IndicadoresBundle\Entity\TipoCampo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\TipoCampo' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\TipoCampo' . "\0" . 'descripcion', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\TipoCampo' . "\0" . 'codigo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoCampo $proxy) {
