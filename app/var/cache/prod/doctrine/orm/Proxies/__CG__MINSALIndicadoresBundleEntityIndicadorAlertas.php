 ...
 */
class IndicadorAlertas extends \MINSAL\IndicadoresBundle\Entity\IndicadorAlertas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorAlertas' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorAlertas' . "\0" . 'limiteInferior', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorAlertas' . "\0" . 'limiteSuperior', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorAlertas' . "\0" . 'color', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorAlertas' . "\0" . 'indicador', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorAlertas' . "\0" . 'comentario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IndicadorAlertas $proxy) {
