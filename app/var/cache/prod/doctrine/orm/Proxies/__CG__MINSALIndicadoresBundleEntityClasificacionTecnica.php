 ...
 */
class ClasificacionTecnica extends \MINSAL\IndicadoresBundle\Entity\ClasificacionTecnica implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionTecnica' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionTecnica' . "\0" . 'codigo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionTecnica' . "\0" . 'descripcion', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionTecnica' . "\0" . 'comentario', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionTecnica' . "\0" . 'indicadores', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionTecnica' . "\0" . 'clasificacionUso'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClasificacionTecnica $proxy) {
