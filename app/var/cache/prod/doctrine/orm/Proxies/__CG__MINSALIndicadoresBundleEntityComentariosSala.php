 ...
 */
class ComentariosSala extends \MINSAL\IndicadoresBundle\Entity\ComentariosSala implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ComentariosSala' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ComentariosSala' . "\0" . 'sala', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ComentariosSala' . "\0" . 'usuario', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ComentariosSala' . "\0" . 'comentario', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ComentariosSala' . "\0" . 'fecha'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ComentariosSala $proxy) {
