 ...
 */
class ResponsableIndicador extends \MINSAL\IndicadoresBundle\Entity\ResponsableIndicador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableIndicador' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableIndicador' . "\0" . 'establecimiento', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableIndicador' . "\0" . 'contacto', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableIndicador' . "\0" . 'correo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableIndicador' . "\0" . 'telefono', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableIndicador' . "\0" . 'cargo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResponsableIndicador $proxy) {
