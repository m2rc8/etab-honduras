 ...
 */
class ClasificacionNivel extends \MINSAL\IndicadoresBundle\Entity\ClasificacionNivel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionNivel' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionNivel' . "\0" . 'codigo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionNivel' . "\0" . 'descripcion', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionNivel' . "\0" . 'comentario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClasificacionNivel $proxy) {
