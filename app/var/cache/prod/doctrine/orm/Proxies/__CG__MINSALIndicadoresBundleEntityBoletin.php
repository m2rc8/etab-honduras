 ...
 */
class Boletin extends \MINSAL\IndicadoresBundle\Entity\Boletin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'nombre', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'creado', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'actualizado', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'token', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'sala', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'grupo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'usuarios', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Boletin' . "\0" . 'enviar'];
        }
    ...
    public function getEnviar()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEnviar', []);

        return parent::getEnviar();
    }
    ...
    public function setEnviar($enviar)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEnviar', [$enviar]);

        return parent::setEnviar($enviar);
    }
