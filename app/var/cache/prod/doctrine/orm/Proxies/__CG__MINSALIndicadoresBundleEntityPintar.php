 ...
 */
class Pintar extends \MINSAL\IndicadoresBundle\Entity\Pintar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Pintar' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Pintar' . "\0" . 'nombre', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Pintar' . "\0" . 'origenes', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Pintar' . "\0" . 'origenesh'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pintar $proxy) {
    ...
    public function addOrigenhe(\MINSAL\IndicadoresBundle\Entity\VariablehPeriodo $origenes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addOrigenhe', [$origenes]);

        return parent::addOrigenhe($origenes);
    }
    ...
    public function removeOrigenhe(\MINSAL\IndicadoresBundle\Entity\VariablehPeriodo $origenesh)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeOrigenhe', [$origenesh]);

        return parent::removeOrigenhe($origenesh);
    }
    ...
    public function getOrigenesh()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrigenesh', []);

        return parent::getOrigenesh();
    }
