 ...
 */
class IndicadorB extends \MINSAL\IndicadoresBundle\Entity\IndicadorB implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorB' . "\0" . 'idIndicadorb', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorB' . "\0" . 'idEstablecimiento', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorB' . "\0" . 'idVariablePeriodo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorB' . "\0" . 'periodo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorB' . "\0" . 'mes'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IndicadorB $proxy) {
    ...
    public function getIdIndicadorb()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdIndicadorb();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdIndicadorb', []);

        return parent::getIdIndicadorb();
    }
