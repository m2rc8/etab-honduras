 ...
 */
class ClasificacionUso extends \MINSAL\IndicadoresBundle\Entity\ClasificacionUso implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionUso' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionUso' . "\0" . 'codigo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionUso' . "\0" . 'descripcion', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionUso' . "\0" . 'comentario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClasificacionUso $proxy) {
