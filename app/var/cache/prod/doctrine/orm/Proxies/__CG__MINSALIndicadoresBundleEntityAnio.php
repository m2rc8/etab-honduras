 ...
 */
class Anio extends \MINSAL\IndicadoresBundle\Entity\Anio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Anio' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Anio' . "\0" . 'nombre', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Anio' . "\0" . 'origenes', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Anio' . "\0" . 'origenesh'];
        }
    ...
    public function addOrigenhe(\MINSAL\IndicadoresBundle\Entity\VariablehPeriodo $origenesh)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addOrigenhe', [$origenesh]);

        return parent::addOrigenhe($origenesh);
    }
