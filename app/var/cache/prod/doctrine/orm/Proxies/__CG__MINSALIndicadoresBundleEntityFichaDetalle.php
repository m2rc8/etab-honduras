 ...
 */
class FichaDetalle extends \MINSAL\IndicadoresBundle\Entity\FichaDetalle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'idFicha', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'idClas', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'gestor', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'tipo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'periodo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm1', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm2', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm3', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm4', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm5', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm6', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm7', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm8', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm9', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm10', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm11', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'm12', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\FichaDetalle' . "\0" . 'observacion'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FichaDetalle $proxy) {
    ...
    public function setGestor($gestor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGestor', [$gestor]);

        return parent::setGestor($gestor);
    }
    ...
    public function getGestor()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGestor', []);

        return parent::getGestor();
    }
